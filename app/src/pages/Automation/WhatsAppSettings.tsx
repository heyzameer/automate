            ...
            <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <button
                            ...
                            className={cn(
                                ...
                                config.botEnabled ? "bg-blue-600" : "bg-gray-200"
                            )}
                        >
                            <span
                                className={cn(
                    ...
                    <div className="pt-6 border-t border-gray-100">
                        ...
                        <div className="space-y-3">
                            <label className="flex items-center gap-3 cursor-pointer">
                                <input 
                                    type="checkbox" 
                                    checked={config.includeGallery}
                                    onChange={(e) => setConfig(prev => ({ ...prev, includeGallery: e.target.checked }))}
                            ...
                            <label className="flex items-center gap-3 cursor-pointer">
                                <input 
                                    ...
                                    onChange={(e) => setConfig(prev => ({ ...prev, includeLocation: e.target.checked }))}
                                    className="w-4 h-4 text-blue-600 rounded border-gray-300 focus:ring-blue-500 bg-white" 
                                />
                ...
                <div className="flex justify-end">
                    <button 
                        onClick={handleSave}
                        disabled={saving}
                        className="flex items-center gap-2 px-6 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium shadow-md shadow-blue-500/20 transition-colors disabled:opacity-50"
                    >
            ...
            <div className="bg-[#e5ddd5] rounded-3xl p-4 shadow-xl border-4 border-gray-800 h-[600px] overflow-hidden flex flex-col relative">
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4">
                    ...
                    <div className="bg-[#dcf8c6] rounded-lg p-3 max-w-[85%] self-end shadow-sm text-sm space-y-2 rounded-tr-none ml-auto text-gray-900">
                        <p className="whitespace-pre-wrap">{config.greetingMessage}</p>

                        <div className="rounded-lg overflow-hidden mt-2 border border-black/5 bg-gray-100 h-32 flex items-center justify-center">
                             <Image className="text-gray-400" size={32} />
                        </div>

                        <div className="space-y-1">
                            <p className="font-bold">Yamaha R15 V4</p>
                            <p>₹ 1,82,000</p>
                            <p className="text-xs text-gray-600">12,000 km • 2022</p>
                        </div>
