...
```bash
git clone https://github.com/your-org/orbix.git
cd orbix
pnpm install
```
...
```bash
# Start MongoDB, Redis, RabbitMQ, Elasticsearch
...
cp server/services/inventory-service/.env.example server/services/inventory-service/.env
cp server/services/whatsapp-bot-service/.env.example server/services/whatsapp-bot-service/.env
...
```env
PORT=5001
MONGODB_URI=mongodb+srv://<user>:<pass>@cluster.mongodb.net/carbot_auth
JWT_SECRET=your-jwt-secret
INTERNAL_SECRET=your-internal-mesh-secret
```

### Inventory Service
```env
PORT=5002
MONGODB_URI=mongodb+srv://<user>:<pass>@cluster.mongodb.net/carbot_inventory
...
```env
PORT=5003
MONGODB_URI=mongodb+srv://<user>:<pass>@cluster.mongodb.net/carbot_bot
...
This starts:
- All 6 microservices + API Gateway
