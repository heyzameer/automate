...
export class CampaignService {
    ...
    async executeCampaign(campaignId: string) {
        ...
        try {
            ...
            const leadRes = await botServiceClient.get('/internal/leads/batch', {
                params: { 
                    tenantId: campaign.tenantId,
                    priority: audiencePriority,
                    leadIds: campaign.audience === 'custom' ? campaign.targetLeadIds : undefined
                }
            });
            ...
            for (const lead of leads) {
                ...
                try {
                    ...
                    if (campaign.type === 'whatsapp') {
                        await botServiceClient.post('/internal/broadcast', {
